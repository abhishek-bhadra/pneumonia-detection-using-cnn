def main():
    ...
    training_set = train_datagen.flow_from_directory(
            basepath + 'D:/2022 PROJECT/2022 Project/22CB 100% delivery/Pnemonia Detection 100% project/traning_set',
            target_size=(64, 64),
            batch_size=32,
            class_mode='categorical')
    
    test_set = test_datagen.flow_from_directory(
            basepath + 'D:/2022 PROJECT/2022 Project/22CB 100% delivery/Pnemonia Detection 100% project/testing_set',
            target_size=(64, 64),
            batch_size=32,
            class_mode='categorical')
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/p_model.h5')
