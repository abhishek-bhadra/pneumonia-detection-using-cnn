...
l1 = tk.Label(window, text="Create a New Account!!", font=("Times new roman", 30, "bold"), fg="black")
l1.place(x=130, y=50)

# that is for label1 registration

l2 = tk.Label(window, text="Full Name :", width=12, font=("Times new roman", 15, "bold"),fg="black")
...
l3 = tk.Label(window, text="Address :", width=12, font=("Times new roman", 15, "bold"),fg="black")
...
l5 = tk.Label(window, text="E-mail :", width=12, font=("Times new roman", 15, "bold"),fg="black")
l5.place(x=130, y=250)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=330, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=12, font=("Times new roman", 15, "bold"),fg="black")
l6.place(x=130, y=300)
t5 = tk.Entry(window, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=330, y=300)
# phone number
l7 = tk.Label(window, text="Gender :", width=12, font=("Times new roman", 15, "bold"),fg="black" )
l7.place(x=130, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=5, font=("bold", 15), variable=var, value=1).place(x=330,
                                                                                                                y=350)
tk.Radiobutton(window, text="Female", padx=20, width=4, font=("bold", 15), variable=var, value=2).place(
    x=440, y=350)

l8 = tk.Label(window, text="Age :", width=12, font=("Times new roman", 15, "bold"),fg="black")
l8.place(x=130, y=400)
t6 = tk.Entry(window, textvar=age, width=20, font=('', 15))
t6.place(x=330, y=400)

l4 = tk.Label(window, text="User Name :", width=12, font=("Times new roman", 15, "bold"),fg="black")
l4.place(x=130, y=450)
t3 = tk.Entry(window, textvar=username, width=20, font=('', 15))
t3.place(x=330, y=450)


l9 = tk.Label(window, text="Password :", width=12, font=("Times new roman", 15, "bold"),fg="black")
l9.place(x=130, y=500)
t9 = tk.Entry(window, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=330, y=500)

l10 = tk.Label(window, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"),fg="black")
l10.place(x=130, y=550)

t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=330, y=550)

btn = tk.Button(window, text="Sign-Up", bg="green",font=("",20),fg="white", width=9, height=0, command = insert)
